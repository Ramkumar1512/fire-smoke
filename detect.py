        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    bot = telepot.Bot("6324373529:AAHi6P1XcC5n9Q8Ym7HeoIeQVtGGBUZnKdg")
                    bot.sendMessage("1473679678", str(names[c]+' detected'))
                    bot.sendPhoto("1473679678",open('result.jpg','rb'))
                    bot1 = telepot.Bot("7090361482:AAGg11EJ1eOgPEpc4YUhyJonbCByiDj3hoM")
                    bot1.sendMessage("564163277", str(names[c]+' detected'))
                    bot1.sendPhoto("564163277",open('result.jpg','rb'))
